...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cordovatest_main);
        setDefaultFragment();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.text2:
                ...
                FragmentManager m2FragmentManager = getSupportFragmentManager();
            ...
            case R.id.text3:
                ...
                FragmentManager m3FragmentManager = getSupportFragmentManager();
